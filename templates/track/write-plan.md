...
- PROJECT.md + OPS.md
- Durable track root path (example: `tracks/2026-02-09-auth/`)
...
tasks:
  - id: T01
    title: <task title>
    depends_on: []
    packet_path: tracks/<track_root>/task-packets/<track_id>-P1-T01.md
  - id: T02
    title: <task title>
    depends_on:
      - T01
    packet_path: tracks/<track_root>/task-packets/<track_id>-P1-T02.md
...
- `packet_path` points to per-task packet file under `tracks/<track_root>/task-packets/`.
...
tasks:
  - id: T01
    ...
    depends_on: []
    packet_path: tracks/2026-02-09-auth/task-packets/auth-P1-T01.md
  - id: T02
    title: Wire middleware to token verifier
    depends_on:
      - T01
    packet_path: tracks/2026-02-09-auth/task-packets/auth-P1-T02.md
nonce: A3F2C1
```
